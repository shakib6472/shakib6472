...
<p dir="auto">
      ...
      >
        <title id="titleId">Abdullah Al Mamun's GitHub Stats, Rank: B-</title>
        <desc id="descId">Total Stars Earned: 78, Total Commits in 2024 : 89, Total PRs: 2, Total Issues: 0, Contributed to (last year): 1</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 170.393978704483;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Abdullah Al Mamun's GitHub Stats</text>
    </g>
      </g>
